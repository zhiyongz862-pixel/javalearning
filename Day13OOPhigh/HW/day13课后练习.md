...
public abstract class Employee {
    private String id;
    private String name;
    private String jobTitle; // 负责的工作（成员变量放在这里）
    ...
    // 每个员工都要工作，但具体怎么做不知道，所以是抽象方法
    public abstract void work();

    // 标准 JavaBean 的 Getter/Setter
...
public abstract class Teacher extends Employee {
    public Teacher(String id, String name, String jobTitle) {
...
public class Lecturer extends Teacher {
    ...
    @Override
    public void work() {
        System.out.println("工号为 " + getName() + " 的讲师正在讲课...");
    }
}
```
